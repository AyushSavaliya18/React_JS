        ...
        <div className="container-fluid my-4">
            <div className="row">
                <div className="col-md-3">
                    <div className="card shadow p-3">
                        ...
                        <div className="mt-3">
                            <button className="btn btn-outline-primary me-2" onClick={() => handleSort("asc")}>
                                Sort Asc
                            </button>
                            ...
                            <div className="col-lg-4 col-md-6 mb-4" key={product._id}>
                                <div className="card h-100 shadow-sm">
                                    ...
                                    <div className="card-body">
                                        ...
                                        <button className="btn btn-outline-success" onClick={() => handleAddToCart(product)}>
                                            Add to Cart
                                        </button>
                                    </div>
                                </div>
            ...
            <Modal show={showModal} onHide={handleModalClose}>
                        ...
                        <ul className="list-group">
                            {cart.map((item) => (
                                <li key={item._id} className="list-group-item d-flex justify-content-between align-items-center">
                                    ...
                                    <button className="btn btn-sm btn-outline-danger" onClick={() => handleRemoveFromCart(item._id)}>
                                        Remove
                                    </button>
                                </li>
                            ))}
                ...
                <Modal.Footer>
                    ...
                    <Button variant="success" onClick={handleProceedToCheckout} disabled={cart.length === 0}>
                        Proceed to Checkout
                    </Button>
                </Modal.Footer>
            </Modal>
